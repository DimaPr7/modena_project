...
class Product(models.Model):
    ...
    photos = models.ManyToManyField("core.Photo", related_name="products", null=True, blank=True)  # Related photos
    ...
    full_collection = models.ManyToManyField("self", blank=True, null=True)
